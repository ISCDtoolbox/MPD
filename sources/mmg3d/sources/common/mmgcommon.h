...
#define MG_VER   "5.3.12"
#define MG_REL   "Oct. 2, 2018"
...
#define MMG5_HGRAD     0.26236426446 /**< default value for gradation */
...
/* Functions declarations */
 ...
 int           MMG5_buildridmet(MMG5_pMesh,MMG5_pSol,int,double,double,double,double*);
 extern int    MMG5_buildridmetfic(MMG5_pMesh,double*,double*,double,double,double,double*);
 int           MMG5_buildridmetnor(MMG5_pMesh, MMG5_pSol, int,double*, double*);
 ...
 void          MMG5_displayLengthHisto_internal(MMG5_pMesh,int,int,int,double,
