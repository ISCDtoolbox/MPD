...
#define _MMG5_MEMMIN 38 /**< minimal memory needed to store the mesh/sol names */
...
#define _MMG5_SAFE_CALLOC(ptr,size,type,retval) do  \
  {                                                 \
...
#define _MMG5_SAFE_MALLOC(ptr,size,type,retval) do  \
  {                                                 \
...
/** Safe reallocation */
#define _MMG5_SAFE_REALLOC(ptr,size,type,message,retval) do \
  {                                                         \
    type* tmp;                                              \
...
#define _MMG5_SAFE_RECALLOC(ptr,prevSize,newSize,type,message,retval) do \
  {                                                                     \
    type* tmp;                                                          \
                                                                        \
...
#define _MMG5_TAB_RECALLOC(mesh,ptr,initSize,wantedGap,type,message,law,retval) do \
  {                                                                     \
    int gap;                                                            \
                                                                        \
